	...
	<div class="container">
		<div class="starter-template">
					...
					<h2>Pet Stores</h2>
						...
						<?php ?>
						<form id="pet_store_a4_form" method="post" class="form-horizontal" action="add_petstore_process.php">
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" class="form-control" name="email" placeholder="Example: john.smith@aol.com"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-4">
												<input type="text" class="form-control" name="notes" placeholder="Notes are optional"/>
										</div>
								</div>
...
<script type="text/javascript">
 ...
 $(document).ready(function() {
	...
	$('#pet_store_a4_form').formValidation({
